...
<article id="privatePolicy" class="container">
<h1>
오늘의식탁(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 회사의 서비스를 이용하는 회원(이하 ‘이용자’라 한다) 의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.
</h1>
<h3>
1. 총칙 <br>
...
가) 일반 회원 가입<br>
- 필수항목: 아이디, 비밀번호, 닉네임, 이메일, 성별, 생년월일<br>
- 선택항목: 사진, 블로그 주소<br>
나) SNS 가입<br>
- 카카오 계정: 이메일, 닉네임, 프로필 사진<br>
- 페이스북 계정: 이름, 이메일, 프로필사진<br>
- 네이버 계정: 이메일, 별명, 프로필 사진,이름(선택), 성별(선택), 생일(선택), 연령대(선택)<br>
- 구글 계정: 이름, 이메일, 프로필 사진, 언어<br>
...
<h3>제3조 개인정보의 수집에 대한 동의</h3>
<h5>회사는 이용자에게 개인정보 수집에 대한 동의를 받고 있으며, 개인정보처리방침 및 이용약관에 대한 동의절차를 마련하여 「동의」버튼을 누르면 개인정보 수집에 대해 동의한 것으로 간주합니다.</h5>

<h3>제4조 개인정보의 수집목적 및 이용목적</h3>
<h5>１. 회사는 이용자에게 서비스를 제공하기 위하여 필요한 개인정보를 수집, 이용하고 있습니다. 수집하는 개인정보 항목에 따른 구체적인 수집목적 및 이용목적은 다음과 같습니다.<br>
...
２. 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보(인종 및 민족, 사상 및 신조, 출신지 및 본적지, 정치적 성향 및 범죄기록, 건강상태 및 성생활 등)는 수집하지 않습니다.</h5>

<h3>제5조 쿠키에 의한 개인정보 수집</h3>
<h5>１. 회사는 이용자의 정보를 저장하고 수시로 찾아내는 ’쿠키(cookie)를 사용합니다. 쿠키는 웹사이트가 이용자의 컴퓨터 브라우저(크롬, 인터넷 익스플로러 등)로 전송하는 소량의 정보를 말합니다.<br>
...
바) 게시판 글 등록 : 쿠키는 브라우저의 종료시나 로그아웃 시 만료됩니다.<br>
</h5>
<h3>제6조 개인정보 제공</h3>
<h5>１. 회사는 이용자들의 개인정보를 제4조에 고지한 범위 내에서 사용하며, 원칙적으로 이용자의 사전 동의 없이는 동 범위를 초과하여 이용하거나 이용자의 개인정보를 외부에 공개하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.<br>
...
３. 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우<br>
</h5>
<h3>제7조 개인정보의 열람, 정정</h3>
<h5>１. 이용자는 언제든지 등록되어 있는 이용자의 개인정보를 열람하거나 정정할 수  있습니다. 개인정보 열람 및 정정을 하고자 할 경우에는 이용자정보수정(http://10000recipe.com/user/update.html)을 통해 직접 열람 또는 정정하거나, 개인정보관리책임자 및 담당자에게 서면, 전화 또는 E-mail로 요청한 경우 회사는 지체 없이 조치하겠습니다.<br>
２. 이용자가 개인정보의 오류에 대한 정정을 요청한 경우, 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다.<br>
３. 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체 없이 통지하여 정정하도록 조치합니다.<br>
</h5>
<h3>제8조 개인정보 수집, 이용, 제공에 대한 동의철회 (이용자탈퇴)</h3>
...
３. 회사는 개인정보의 수집에 대한 동의철회(회원탈퇴)를 개인정보를 수집하는 방법보다 쉽게 할 수 있도록 필요한 조치를 하겠습니다.<br>
</h5>
<h3>제9조 개인정보의 보유기간 및 이용기간, 파기절차, 파기방법</h3>
<h5>
...
아) 그 외 내부 관리자의 실수나 기술관리 상의 사고로 인해 개인정보의 상실, 유출, 변조, 훼손이 유발될 경우 회사는 즉각 이용자께 사실을 알리고 적절한 대책과 보상을 강구할 것입니다.<br>
</h5>
<h3>제11조 링크사이트</h3>
<h5>
...
２. 근본적으로 게시물에 관련된 제반 권리와 책임은 작성자 개인에게 있습니다. 또 게시물을 통해 자발적으로 공개된 정보는 보호받기 어려우므로 정보 공개 전에 심사숙고 하시기 바랍니다.<br>
</h5>

<h3>제13조 개인정보의 위탁처리</h3>
<h5>
...
나) 개인정보의 처리를 위탁하는 경우에는 위탁계약 등을 통하여 서비스제공자의 개인정보보호 관련 지시엄수, 개인정보에 관한 비밀유지, 제3자 제공의 금지 및 사고시의 책임부담, 위탁기간, 처리 종료후의 개인정보의 반환 또는 파기 등을 명확히 규정하고 당해 계약내용을 서면 또는 전자적으로 보관하겠습니다.<br>
</h5>
<h3>제14조 형태정보 제공에 대한 메체사 고지</h3>
<h5>
회사는 아래의 광고사업자가 회사의 서비스 내 생성정보 분석 툴을 통해 온라인 상의 이용자 형태정보를 수집하고 이용자 대상 맞춤형 광고 서비스 전송 목적으로 이용할 수 있도록 허용하고 있습니다.<br>
- (주)엔에이치엔에이스 (NHN ACE)<br>
</h5>
<h3>
...
７. 이용자는 개인정보를 보호받을 권리와 함께 스스로를 보호하고 타인의 정보를 침해하지 않을 의무도 가지고 있습니다. 비밀번호를 포함한 이용자의 개인정보가 유출되지 않도록 조심하시고 게시물을 포함한 타인의 개인정보를 훼손하지 않도록 유의해 주십시오. 만약 이 같은 책임을 다하지 못하고 타인의 정보 및 존엄성을 훼손할 시에는 정보통신망이용촉진 및 정보보호등에관한법률등에 의해 처벌받을 수 있습니다.<br>
</h5>

<h3>제16조 의견수렴 및 불만처리</h3>
<h5>
...
５. 기타 개인정보에 관한 상담이 필요한 경우에는 개인정보침해신고센터로 문의하실 수 있습니다.<br>
...
라) 경찰청 사이버테러대응센터 (www.ctrc.go.kr / 02-392-0330)<br>
</h5>
<h3>
제17조 정보관리책임자 및 담당자
</h3>
...
- 소속 : 기획팀<br>
- 성명 : 서진수<br>
- E-mail : cutler@10000recipe.com<br>
- 전화번호 : 02-323-5002<br>
- FAX : 02-323-5049<br>
</h5>
...
５. 팩스·휴대폰 문자전송 등 전자우편 이외의 문자전송을 통해 영리목적의 광고성 정보를 전송하는 경우에는 전송내용 처음에 “(광고)”라는 문구를 표기하고 전송내용 중에 전송자의 연락처를 명시하도록 조치합니다.<br>
</h5>

<h3>제19조 변경에 따른 공지의무</h3>
<h5>
...
<br>
- 2017년 11월 26일~2019년 3월 6일 적용 보기<br>
- 2015년 6월 1일~2017년 11월 25일 적용 보기<br>
</h5>
</article>
